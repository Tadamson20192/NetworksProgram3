...
if __name__ == '__main__':
    ...
    router_a = network.Router(name='A', intf_count=2, max_queue_size=router_queue_size, forwardTable=forward_a)
    object_L.append(router_a)
    
    router_b = network.Router(name='B', intf_count=1, max_queue_size=router_queue_size, forwardTable=forward_b)
    object_L.append(router_b)
    
    router_c = network.Router(name='C', intf_count=1, max_queue_size=router_queue_size, forwardTable=forward_c)
    object_L.append(router_c)
    
    router_d = network.Router(name='D', intf_count=2, max_queue_size=router_queue_size, forwardTable=forward_d)
